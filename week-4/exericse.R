...
type2.pkm <- group_by(pokemon, Type.2)

# View your new variable -- did it affect anything?

# it did not affect anything- i think.
...
summarize(type2.pkm, mean(Speed), max(HP))
